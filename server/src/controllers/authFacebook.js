...
// // 1️⃣ Cấu hình chiến lược Facebook cho Passport
// passport.use(
...
// // 2️⃣ Middleware khởi tạo Passport
// export const initFacebookAuth = (app) => {
//     app.use(passport.initialize());
// };

// // 3️⃣ Route: chuyển hướng người dùng tới Facebook login
// export const facebookLogin = passport.authenticate("facebook", {
//     scope: ["email"],
// });

// // 4️⃣ Route: callback Facebook sẽ gọi về
